...
@section('content')
    ...
    <div class="mb-5 flex items-center gap-2">
        ...
        <span class="max-w-[200px] truncate text-sm text-slate-500">{{ $user->name }}</span>
    </div>
    ...
    <form method="POST" action="{{ route('admin.usuarios.update', $user) }}">
        ...
        <div class="grid gap-6 lg:grid-cols-2 lg:items-start">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
                <div class="mb-6">
                    <h1 class="font-heading text-xl font-bold text-brand-navy">Edit User</h1>
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div>
                            <label for="password" class="block text-xs font-semibold uppercase tracking-wide text-brand-navy">New Password</label>
                            <p class="mt-0.5 text-xs text-slate-400">Leave blank to keep current.</p>
                        ...
                        <div>
                            ...
                            <p class="mt-0.5 text-xs text-slate-400">&nbsp;</p>
